...
create table asiento_reservados(
	id int primary key auto_increment,
...
desc asiento_reservados;

#ingresar los datos de las peliculas
desc peliculas;
INSERT INTO PELICULAS (NOMBRE, DURACION)
...
#ingresar los datos de las salas
desc sala;
INSERT INTO SALA (NOMBRE, N_ASIENTOS) 
VALUES ('Iñarritu',72),
('Cuaron',36),
('Del Toro',36);
select*from sala;

#ingresar los datos de las funciones
desc funcion;
INSERT INTO FUNCION (ID_PELICULA, ID_SALA, HORA_INICIO)
...
#ingresar satos de los asientos
desc asiento;
...
#ingresar satos de las reservaciones
desc reservacion;
INSERT INTO RESERVACION (ID_FUNCION,ID_CLIENTE)
...
#ingresar satos de los asientos reservados
desc asiento_reservados;
INSERT INTO ASIENTO_RESERVADOS (ID_RESERVACION, ID_ASIENTO) 
VALUES 
...
select*from asiento_reservados;
